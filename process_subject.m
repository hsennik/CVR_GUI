...
sp.again = uicontrol('Style','pushbutton',...
                    'Visible','on',...
                    'Enable','on',...
                    'Value',0,'Position',[270,965,30,30],...
...
sp.convert_files = uicontrol('Style','pushbutton',...
                             ...
                             'Enable','on',...
                             'Value',0,'Position',[50,835,200,60],...
...
if sp.study_selection.Value == 2 || sp.study_selection.Value == 3 % if the study selection is BH/HV/Motor or GA
    ...
    sp.specify_first = uicontrol('Style','text',...
                                'units','normalized',...
                                'Position',[0.05,0.702,0.635,0.02],...
                                'String',string1);                                    

    sp.specify_second = uicontrol('Style','text',...
                                'units','normalized',...
                                'Position',[0.05,0.665,0.75,0.02],...
                                'String',string2);  
                            
    sp.enter_prompt = uicontrol('Style','text',...
                                'units','normalized',...
                                'Position',[0.05,0.595,0.9,0.02],...
                                'String','Press enter after filling fields.');
    
    %  Create edit boxes to enter the number of each study                         
    sp.specify_first_textbox = uicontrol('Style','edit',...
                                        'Units','pixels',... 
                                        'Enable','on',...
                                        'Position',[245,705,35,20]); 

    sp.specify_second_textbox = uicontrol('Style','edit',...
                                        'Units','pixels',...
                                        'Enable','on',...
                                        'Position',[245,670,35,20]);                                  
    ...
    if sp.study_selection.Value == 2 % if the study selection is BH/HV/Motor, then create a third study information field for motor                              
        sp.specify_third = uicontrol('Style','text',...
                                    'units','normalized',...
                                    'Position',[0.05,0.63,0.68,0.02],...
                                    'String',string3);
                                
        sp.specify_third_textbox = uicontrol('Style','edit',...
                                          'Units','pixels',...
                                          'Enable','on',...
                                          'Position',[245,635,35,20]);
...
sp.process = uicontrol('Style','togglebutton',...
                ...
                'Value',0,'Position',[50,495,200,60],...
                'callback',{@processing_pipeline,subj,directories});
            
%  Tell the user to wait for the subject to be processed
sp.create_mask_selection = uicontrol('Style','checkbox',...
                'units','normalized',...
                'Enable','off',...
                'Position',[0.15,0.56,0.75,0.02],...
                'Value',1,...
                'String','Create segmentation masks');           
            
if strcmp(process_string,'Process Subject');
    
    set(sp.create_mask_selection,'Enable','on');
...
if strcmp(subj.proc_rec_sel,'MOT') == 1 || strcmp(subj.proc_rec_sel,'SENS') == 1
    ...
    if strcmp(subj.breathhold, subj.proc_rec_sel) == 0
...
sp.alternative_methods = uicontrol('Style','popupmenu',...
                        'Visible','on',...
                        'String',{'','Standard Sawtooth','Respiratory Bellows','End tidal CO2'},...
                        'HandleVisibility','on',...
